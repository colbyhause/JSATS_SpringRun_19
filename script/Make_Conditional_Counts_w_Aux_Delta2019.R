...
# Load Delta RELEASE dataframe with just first visits ---------------------------------------------------------------
data <- readRDS("data_output/DeltaRel_visits2019_first.rds")
...
write.csv(input, 'data_output/2019_DeltaRelease_counts_NoBridges.csv')
...
write.csv(Aux, "data_output/2019_DeltaRel_Cond_Aux_counts_NoBridges.csv")
