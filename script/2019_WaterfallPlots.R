...
# FIRST: run the function "plot_all_rkm_time_jsats" in the scripts folder of the 
# JSATS_SpringRun_19 project(C:\Users\chause\Documents\GitHub\JSATS_SpringRun_19\script\2019WaterFall_PLot_Function.Rmd)
...
dets_up<- read_rds("data_output/DetectionFiles/upper_dets_raw.rds")
dets_ds<- read_rds("data_output/DetectionFiles/delta_dets_raw.rds")
...
print_tags(dets_up, "2019UpperDets_Indiv_WFPlots")
print_tags(dets_ds, "2019DeltaDets_Indiv_WFPlots")
...
# run function "plot_all_rkm_time_jsats" which makes the waterfall plots of all the detections.
plot_all_rkm_time_jsats(df =dets_16pf_up,df_tag_list = dets_16pf_up, tag_colname = "Hex", str_start_datetime = "2019-01-01 00:00:00",
                        str_end_datetime = "2019-09-01 00:0:00", high_rkm = 350, low_rkm = 0, pdf_name = "UpperRel_WFplot_PredFilter+w_gg_Chipps", 
